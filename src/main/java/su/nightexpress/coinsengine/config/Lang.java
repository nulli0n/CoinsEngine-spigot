...
public class Lang {
    ...
    public static final LangString COMMAND_MIGRATE_USAGE = LangString.of("Command.Migrate.Usage", "<plugin> <currency>");
    ...
    public static final LangString COMMAND_RESET_USAGE = LangString.of("Command.Reset.Usage", "<player>");
    ...
    public static final LangString COMMAND_WIPE_DESC  = LangString.of("Command.Wipe.Desc", "Reset all currencies for all users.");
    public static final LangString COMMAND_WIPE_USAGE = LangString.of("Command.Wipe.Usage", "<currency>");
    ...
    public static final LangString COMMAND_CURRENCY_BALANCE_USAGE = LangString.of("Command.Currency.Balance.Usage", "[player]");
    public static final LangString COMMAND_CURRENCY_BALANCE_DESC  = LangString.of("Command.Currency.Balance.Desc", "Check [player's] currency balance.");

    public static final LangString COMMAND_CURRENCY_GIVE_USAGE = LangString.of("Command.Currency.Give.Usage", "<player> <amount> [-s]");
    ...
    public static final LangString COMMAND_CURRENCY_TAKE_USAGE = LangString.of("Command.Currency.Take.Usage", "<player> <amount> [-s]");
    ...
    public static final LangString COMMAND_CURRENCY_SET_USAGE = LangString.of("Command.Currency.Set.Usage", "<player> <amount> [-s]");
    ...
    public static final LangString COMMAND_CURRENCY_SEND_USAGE = LangString.of("Command.Currency.Send.Usage", "<player> <amount>");
    ...
    public static final LangString COMMAND_CURRENCY_PAYMENTS_USAGE = LangString.of("Command.Currency.Payments.Usage", "[player] [-s]");
    ...
    public static final LangString COMMAND_CURRENCY_EXCHANGE_USAGE = LangString.of("Command.Currency.Exchange.Usage", "<currency> <amount>");
    ...
    public static final LangString COMMAND_CURRENCY_TOP_USAGE = LangString.of("Command.Currency.Top.Usage", "[page]");
